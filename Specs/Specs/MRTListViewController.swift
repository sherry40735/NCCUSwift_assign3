...
class MRTListViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.mrtMapper = mrtDataManager.readSourceData()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        for line in nameOfLines {
            ...
            if indexOfLine == 0 {
                ...
                lbl_Line0.text = linesOfStation[line]
            }
            else {
                lbl_Line1.isHidden = false
                lbl_Line1.backgroundColor = color
                lbl_Line1.text = linesOfStation[line]
            }
        }
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showDetail" {
            ...
            guard let destination = segue.destination as? MRTDetailViewController else {
                return
            }
